...
<nav id="sidebar" class='mx-lt-5 bg-dark' >	
		<div class="sidebar-list">
				...
				<a href="index.php?page=analytic" class="nav-item nav-analytic"><span class='icon-field'><i class="fa fa-chart-bar"></i></span> Analytic</a>
				...
				<a href="index.php?page=users" class="nav-item nav-users"><span class='icon-field'><i class="fa fa-users"></i></span> User List</a>
			<?php endif; ?>
		</div>
